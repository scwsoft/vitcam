...
import { ArrowLeft, Camera, Monitor, Save, Settings } from 'lucide-react'
...
export default function AddCameraPage() {
  ...
  const { formData, errors, submitting, updateField, handleSubmit } = useCameraForm()
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-lg">
              Configure a new security camera with AI detection capabilities
            </p>
          </div>
        </div>
