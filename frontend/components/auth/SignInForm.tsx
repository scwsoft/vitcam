  ...
  const handleGithubLogin = async () => {
    try {
      ...
      const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'github',
        options: {
          redirectTo: `https://discord.com/oauth2/authorize?client_id=1467555835319419077&response_type=code&redirect_uri=http%3A%2F%2F127.0.0.1%3A54321%2Fauth%2Fv1%2Fcallback&scope=identify+email`,
        },
      });
      if (error) throw error;
    } catch (error) {
